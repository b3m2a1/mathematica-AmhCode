...
MakeBoxes[MathematicaClassBoxForm[m:MathematicaClass[_Symbol?ObjectSymbolQ]],StandardForm]:=
	repr[m,StandardForm];
MakeBoxes[MathematicaClassBoxForm[m:MathematicaClass[_Symbol?ObjectSymbolQ]],TraditionalForm]:=
	repr[m,StandardForm];
